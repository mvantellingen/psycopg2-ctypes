...
def _reg_type(name, oids, caster, base_caster=None):
    type_obj = Type(name, oids, caster, base_caster=base_caster)
...
DECIMALARRAY = _reg_type('DECIMALARRAY', [1231], cast_generic_array, DECIMAL)
STRINGARRAY = _reg_type('STRINGARRAY', [1002, 1003, 1009, 1014, 1015],
    cast_generic_array, STRING)
BINARYARRAY = _reg_type('BINARYARRAY', [1001], cast_generic_array, BINARY)
